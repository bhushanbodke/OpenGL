...
void Shader::SetUniformVec3(const std::string& name, float f1, float f2, float f3)
{
...
{
    GLCALL(glUniform3f(glGetUniformLocation(ID, name.c_str()),vector.x,vector.y,vector.z));
}
